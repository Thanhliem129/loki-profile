...
import { postMovie } from '../../redux/myMovie/action'
...
const AddMovie = () => {
  ...
  const [createUser, setCreateUser] = useState(currentUser.fullName)
  ...
  const handleAddMovie= () => {
    ...
    if(currentUser){
      dispatch(postMovie(currentUser.id, body))
    }
  }
  return(
    <div className='background-profile'>
      <div className='container py-4 '>
        ...
        <div className='bg-dark mt-4 p-4'>
          <button type="button" className="btn-add-image my-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
            Thêm ảnh
          </button>
              ...
              <div className="modal-content">
                  ...
                  <div className='row w-100  my-2'>
                    ...
                    <input 
                      ...
                      value={thumnail}
                      onChange={text => setThumnail(text.target.value)}
                    />
                  </div>
          ...
          <div>
            <div className='d-block'>
              <img src={thumnail} className='image-add-post' alt='imagesss-add-posts' />
            </div>
            ...
            <div className='row align-items-center my-3'>
              <label className='col-form-label text-white col-md-3'>Link movie</label>
              <div className='col-md-9'>
                <input 
                  className='form-control'
                  value={link}
            ...
            <div className='row align-items-center my-3'>
              <label className='col-form-label text-white col-md-3'>Thể loại phim</label>
              <div className='col-md-9'>
                <input 
                  className='form-control'
                  value={type}
            ...
            <div className='d-flex justify-content-center'>
              <button className='btn-add-image mt-4' onClick={handleAddMovie}>Đăng phim</button>
            </div>
          </div>
        </div>
      </div>
